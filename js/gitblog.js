var gitblog = function(config) {
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = 'Powered 2023 by <a href="https://github.com/xiaotian2333" target="_blank" style="color: aquamarine;text-decoration:none;border-bottom: 1px solid #79f8d4;">Walkthrough-sharing</a>';
    }
